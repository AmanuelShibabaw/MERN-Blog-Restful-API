...
const {profileupadtingValidator,validateSignUp,validateSignIn,verificationValidator, CodeValidator, emailValidator, recoverPassValidator, changePassValidator} = require('../validator/auth') 
...
router.put('/update-profile',profileupadtingValidator,validate,validateToken,authController.updateProfile)
